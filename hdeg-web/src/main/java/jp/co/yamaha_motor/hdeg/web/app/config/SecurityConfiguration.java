package jp.co.yamaha_motor.hdeg.web.app.config;

import jp.co.yamaha_motor.hdeg.web.app.config.auth.DummyAuthenticationInterceptor;
import jp.co.yamaha_motor.hdeg.web.app.config.auth.PJUserDetailsServiceLoader;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain webSecurityCustomizer(HttpSecurity http) throws Exception {
        http.securityMatcher("/**/webjars/**","/**/resources/**","/**/ynawebjars/**","/**/public/**", "/**/static-res/**", "/monitor/**", "/error")
