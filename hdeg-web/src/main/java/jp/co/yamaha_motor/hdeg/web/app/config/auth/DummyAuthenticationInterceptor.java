package jp.co.yamaha_motor.hdeg.web.app.config.auth;
...
public class DummyAuthenticationInterceptor extends OncePerRequestFilter {
    ...
    static final String DUMMY_USERNAME = "DUMMY_USERNAME";
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (auth == null || "anonymousUser".equals(auth.getPrincipal())) {
            ...
            // If the dummy username is not set in the request header, use the default dummy username.
            String usernameFromDummy = request.getHeader(DUMMY_USERNAME);
            if(StringUtils.isEmpty(usernameFromDummy)) {
                usernameFromDummy = username;
            }

            Map<String, String> userInfo = new HashMap<>();
            userInfo.put("username", usernameFromDummy);
