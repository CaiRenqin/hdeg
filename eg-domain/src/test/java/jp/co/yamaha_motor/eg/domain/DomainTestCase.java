...
import jp.co.yamaha_motor.eg.domain.test.BaseDomainTest;
...
class DomainTestCase extends BaseDomainTest {
     ...
     */
    @DisplayName("Check if application name from properties is 'eg-domain-test'")
    @Test
    void testCheckApplicationName() {
        ...
        // Assert
        assertThat(actualAppName).isEqualTo("eg-domain-test");
    }
}
