package jp.co.yamaha_motor.eg.web.app.controller;
...
import jp.co.yamaha_motor.eg.web.app.config.auth.PJUserDetails;
import jp.co.yamaha_motor.eg.web.app.form.UserInfoModel;
...
public class UserController implements RestProcessAware {
     ...
     */
    @Operation(summary = "Change locale of current user")
