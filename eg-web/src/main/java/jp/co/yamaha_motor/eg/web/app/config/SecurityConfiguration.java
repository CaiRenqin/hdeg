package jp.co.yamaha_motor.eg.web.app.config;

import jp.co.yamaha_motor.eg.web.app.config.auth.DummyAuthenticationInterceptor;
import jp.co.yamaha_motor.eg.web.app.config.auth.PJUserDetailsServiceLoader;
